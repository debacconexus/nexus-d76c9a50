...
process.env.NEXUS_NAME = process.env.NEXUS_NAME || "Multi-Clinic Patient Coordination Hub";
process.env.ENTITY_LABEL = process.env.ENTITY_LABEL || "Patient";
process.env.TABLE_NAME = process.env.TABLE_NAME || "patient_records";
'use strict';
